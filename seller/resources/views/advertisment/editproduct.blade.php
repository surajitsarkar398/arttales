        ...
        <div class="form-row">
            ...
            <div class="col-sm-6"style="margin-top: 40px;">
                ...
                <div class="card-header">
                    ...
                    <form  action="{{URL('product/editproduct/saveEdit')}}"  enctype="multipart/form-data" method="post">
                    ...
                    <div class="card-body">
                     <div class="form-group">
                           <input class="form-control p" type="text"  id="demo-text-input" name="product_name" value='{{  $productlist->product_name }}'>
                        </div>
                      <div class="form-group">    
                       ...
                       <input type='button' id='bt2' class="btn btn-light remove" onclick="$(this).closest('DIV.file_rows').remove();" value='delete' style="padding: 0px 9px 0px;  font-size: 12px;  height: 38px; padding-bottom: 0px;"/>
                            ...
                            @endforeach
                                ...
                                <input type='button' id='bt1' class="btn btn-light" onclick="$(this).closest('DIV.file_row').remove();"    value='Cancel' style="padding: 0px 25px 4px;  font-size: 12px; margin-left: 12px; height: 38px; padding-bottom: 0px;" />
                                    ...
                                    <input type='button' class="btn btn-light" id='bt' onclick="onclickAddFile()" value='Add Image' style="margin-left: 2%;" />
                          ...
                          <div class="form-group">
                          <input class="form-control p" type="text"  id="demo-text-input" name="price"value='{{  $productlist->price }}'>
                        </div>
                        <div class="form-group">
                            <input class="form-control" type="text"  id="demo-tel-input"  name="discount" value='{{  $productlist->discount }}'>
                        </div>
                          <div class="form-group">
                            <input class="form-control" type="text"  id="demo-tel-input" name="offer_price" value='{{  $productlist->offer_price }}'>
                        </div>
                         <div class="form-group">
                            <input class="form-control" type="text" name="product_description"  id="demo-email-input" value='{{  $productlist->product_description }}'>
                        </div>
                          <div class="form-group">
                            <input class="form-control" type="text" name="limited_stock"  id="demo-email-input" value='{{  $productlist->limited_stock }}'>
                        </div>
                    </div>
                     
                        <center><button type="submit" class="btn btn-primary mr-2" style="margin-bottom: 22px;width: 160px;">Update</button></center>
                    </form>
                </div>
            </div>
