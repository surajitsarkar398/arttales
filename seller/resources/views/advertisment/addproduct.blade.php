            ...
            <div class="page-block">
                <div class="row align-items-center">
                    <div class="col-md-6">
                        ...
                        <div class="page-header-title">
                            <h5 class="m-b-10">Add Advertisment</h5>
                        </div>
                        <div class="col-md-12">
                            <!--      <ul class="breadcrumb">
            ...
            <div class="col-sm-6" style="margin-top: 40px;">
                ...
                <div class="card ">
                    <div class="card-header">
                        <h5>Add Advertisment</h5>
                    </div>
                    @include('alert_message')
                    <form action="{{route('advertisment.store')}}" enctype="multipart/form-data" method="post">
                        @csrf
                        <div class="card-body">
                            <div class="form-group">
                                <input class="form-control p" type="text" id="demo-text-input" name="product_name" placeholder="Enter Your ProductName">
                            </div>
                            <div class="form-group  col-md-12" id="cloned">
                                ...
                                <div id="t1">
                                    <div class="file_row d-flex">
                                        <input type="file" name="product_image[]" required="required" class="form-control" multiple>
                            ...
                            <div class="form-group">
                                <input class="form-control p" type="text" id="demo-text-input" name="price" placeholder="Enter Your Poduct Price">
                            </div>
                            <div class="form-group">
                                <input class="form-control" type="text" id="demo-tel-input" placeholder="Enter Your Product Discount" name="discount">
                            </div>
                            <div class="form-group">
                                <input class="form-control" type="text" id="demo-tel-input" placeholder="Enter Your Product Offer Price" name="offer_price">
                            </div>
                            <div class="form-group">
                                <input class="form-control" type="text" id="demo-tel-input" placeholder="Enter Your Product Stock" name="limited_stock">
                            </div>
                            <div class="form-group">
                                <input class="form-control" type="text" name="product_description" id="demo-email-input" placeholder="Enter Your Product Description">
                            </div>
                        </div>
