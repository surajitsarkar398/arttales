                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <div class="form-group  col-md-12" id="cloned">
                                            ...
                                            <input class="form-control p" type="text" id="demo-text-input" name="product_name" placeholder="Enter Your name"></br>
                                        </div>
                                        <div class="form-group  col-md-12" id="cloned">
                                            <label for="demo-input-file" class="col-form-label">Choose Product Image</label>
                                            <input class="form-control p" type="text" id="demo-text-input" name="product_name" placeholder="Enter Your Phone">
                                        </div>
                                        <div class="form-group  col-md-12" id="cloned">
                                            <label for="demo-input-file" class="col-form-label">Choose Product Image</label>
                                            <div id="t1">
