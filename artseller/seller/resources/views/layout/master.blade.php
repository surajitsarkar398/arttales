        ...
        <div class="navbar-wrapper">
            ...
            <div class="navbar-content">
                <ul class="pc-navbar">
                    ...
                    <li class="pc-item pc-hasmenu">
                        <a href="{{URL('/product')}}" class="pc-link "><span class="pc-micon"><i data-feather="shopping-cart"></i></span><span class="pc-mtext">Products</span><span class="pc-arrow"></span></a>
                    </li>
                    <li class="pc-item pc-hasmenu">
                        <a href="{{URL('/product_list')}}" class="pc-link "><span class="pc-micon"><i data-feather="shopping-cart"></i></span><span class="pc-mtext">Products List</span><span class="pc-arrow"></span></a>
                    </li>
                    <li class="pc-item pc-hasmenu">
                    ...
                    <li class="pc-item pc-hasmenu">
                        <a href="{{URL('advertisment')}}" class="pc-link "><span class="pc-micon"><i data-feather="life-buoy"></i></span><span class="pc-mtext">Advertisement Request</span><span class="pc-arrow"></span></a>
                    </li>
                    <li class="pc-item pc-hasmenu">
                    ...
                    <li class="pc-item pc-hasmenu">
                        <a href="{{URL('/profile')}}" class="pc-link "><span class="pc-micon"><i data-feather="user"></i></span><span class="pc-mtext">Manage Profile</span><span class="pc-arrow"></span></a>
                    </li>
