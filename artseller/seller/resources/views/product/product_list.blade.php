                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <div class="page-header-title">
                           <a href="#"><h5 class="m-b-10">Product List</h5></a>
                        </div>
                                ...
                                <tbody>
                                    @forelse ($productlist as $no => $product)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route ('product.edit',$product->product_id) }}" class="btn btn-info btn-sm"><i class="feather icon-plus"></i>&nbsp;ADD</a>
                                            </td> 
                                        </tr>
                                    @empty
