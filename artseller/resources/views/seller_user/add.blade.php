            ...
            <div class="page-block">
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <div class="page-header-title">
                           <a href="{{ $artist ? route('artist.edit',$artist->register_id)  : route('artist.create')  }}">
                                <h5 class="m-b-10">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4> {{ $artist ? 'Edit' : 'Create' }} Your Artist</h4>
                    </div>
                    <div class="card-body">
                         @include('alert_message')
                        <form action="{{ $artist ? route('artist.update') : route('artist.store') }}" method="POST" id=" {{ $artist ? '' :'artistForm' }}"  enctype="multipart/form-data" >
                            @csrf
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3">
                                            ...
                                            value="{{ $artist ? $artist->country_code : ''}}">
                                        </div>    
                                        <div class="col-lg-9">
                            ...
                            <div class="row formfields form-group">
                                <div class="col-lg-4">
                                    ...
                                    <select  name="category" id='category' class="form-control"  onchange="fetchSubcategory(this.id)">
                            ...
                            <div class="formfields form-group">
                                ...
                                <textarea class="form-control" name="description" placeholder="About your self...">{{ $artist ? $artist->description : ''}}</textarea>
                            </div>    
