            ...
            <div class="page-block">
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <div class="page-header-title">
                           <a href="{{ route('artist-lover.detail',$artist->register_id) }}">
                                <h5 class="m-b-10"> Artist Lover Detalis
                                </h5>
                            </a>
                        </div>
                    </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4> Details of Your Artist Lover</h4>
                    </div>
                    <div class="card-body">
                         @include('alert_message')
                            ...
                            <div class="row formfields form-group">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <br/>
                                    @if(!empty($artist))
                                         <img src="{{ URL('public/images/artistLover') }}/{{ $artist->image }}" alt="" height="80px" width="80px">
                                    @endif   
                                </div> 
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <select class="form-control" name="role" disabled>
                                       <option value="select">Select</option>
                                        ...
                                        @if(!empty($artist))
                                            <option  @if($artist->user_type ===  'artist_lover') selected @endif value="Artist Lover" >Artist Lover</option>
                                        @else
                            ...
                            <div class="formfields text-right">
                                ...
                                <a href="{{ route('artist-lover.index') }}"><button  class="btn btn-primary mr-2">Back</button></a>
                            </div>  
