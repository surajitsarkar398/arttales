                                ...
                                <tbody>
                                    @forelse ($productlist as $no => $product)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route ('product.edit',$product->product_id) }}" class="btn btn-info btn-sm"><i class="feather icon-edit"></i>&nbsp;Edit </a>
                                               </td> 
                                            <td>
                                                <form action="{{route('product.destroy',$product->product_id)}}" method="get">
                                                     @csrf
                                                 @method('DELETE')
