                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="dt-responsive table-responsive">
								...
								<div class="row">
									<div class="col-md-4">
										<label for="store_name"><b>Store Details : </b></label>
									</div>
									<div class="col-md-8">
										{{ $storelist->detail }}
									</div>
								...
								<div class="row">
									<div class="col-md-4">
										<label for="address"><b>Attachment : </b></label>
									</div>
									<div class="col-md-8">
										<img src="{{ URL('public/uploads') }}/{{ $storelist->attachment }}" alt="" height="50px" width="50px">
									</div>
								</div>
