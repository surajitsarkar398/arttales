                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Approve store List</h5>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <table id="simpletable" class="table table-striped table-bordered nowrap">
                                ...
                                <tbody>
                                    <tr>
                                            ...
                                            <td class="thandtd">
                                            @if($store->isban == 1)
                                                <a onClick="Blockapproval({{$store->store_id}}, 0)" style="cursor:pointer">
                                            ...
                                            @else
                                                <a onClick="Blockapproval({{$store->store_id}}, 1)" style="cursor:pointer">
...
<script type="text/javascript">
    function Blockapproval(Id, Status)
    {
        $("#LoadingProgress").fadeIn('fast');
        
        $.ajax({
            url: "{{ URL('/store/Blockapproval') }}/"+Id+"/"+Status,
            type: "GET",
            contentType: false,
            cache: false,
            processData:false,
