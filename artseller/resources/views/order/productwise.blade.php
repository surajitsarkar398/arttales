                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">ProductWise Order List</h5>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                            ...
                            <form  action="{{URL('/order/product_report')}}"  method="get" class="form-inline-my-2 my-lg-0 d-flex+"> 
                            @csrf
                    ...
                    <div class="card-body">
                        <a target="_blank" href="{{ route('order.product_report') }}?print=1&<?php echo $_SERVER['QUERY_STRING']; ?>" class="btn btn-success btn-sm">Print Report</a><br>
