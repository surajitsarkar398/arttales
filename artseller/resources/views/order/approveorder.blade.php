                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Approve Order List</h5>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="dt-responsive table-responsive">
                            <table id="simpletable" class="table table-striped table-bordered nowrap">
                              ...
                              <select class="form-control" id="order_status" name="order_status" onchange="selected()">
   ...
   function  selected(){
    ...
    var order_status = $('#order_status').val();
      ...
      $.ajax({
       ...
       url: "{{ URL('/order/orderStatusUpdate') }}",
...
// $(document).ready(function(){
  ...
  //       let a = document.getElementsByTagName('order_status');
  // a.change(function(){
  //   alert("Hello");
  //   var order_id = $('#order_id').val();
  //   var order_status = $('#order_status').val();
