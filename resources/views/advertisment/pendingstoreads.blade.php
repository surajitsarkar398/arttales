                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Pending Store Ads List</h5>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <table id="simpletable" class="table table-striped table-bordered nowrap">
                                ...
                                <tbody>
                                    <tr>
                                            <td>{{ $no +1 }}</td>
                                            <td>{{ $ads->ads_type }}</td>
                                                <td><a href="{{URL('/advertisment/viewstores',$ads->ads_id) }}" data-toggle="modal" onclick="view_modal(this.id)" title="User Details"  id ="{{ $ads->ads_id }}" data-target="#modal_view">View</a>
                                             </td>
                                            <td>{{ $ads->name }}</td>
                                            ...
                                            @else
                                               <a href="{{URL('/advertisment/ChangeStatusStore',$ads->ads_id) }}" class="btn btn-primary btn-sm">Pending Approval</a></td>
                                            @endif()
...
<script  type="text/javascript">
  ...
  function view_modal(id){
    $.ajax({
      type : 'get',
      url : "{{ URL('/advertisment/viewstores') }}/"+id,
      // data :  'id='+ id, 
