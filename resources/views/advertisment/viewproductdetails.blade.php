	...
	<div class="row">
		<div class="col-md-4">
			<label for="store_name"><b>product Name  : </b></label>
		</div>
		<div class="col-md-8">
			{{ $adslist->product_name }}
		</div>
	</div>
	<hr>
	<div class="row">
		<div class="col-md-4">
			<label for="category"><b>product image : </b></label>
		</div>
		<div class="col-md-8">
 			 @foreach(explode(',',$adslist->product_image)  as $images)
