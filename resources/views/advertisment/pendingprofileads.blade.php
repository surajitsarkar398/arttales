                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Pending Profile Ads List</h5>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <table id="simpletable" class="table table-striped table-bordered nowrap">
                                ...
                                <tbody>
                                    <tr>
                                            <td>{{ $no +1 }}</td>
                                            <td>{{ $ads->ads_type }}</td>
                                            <td><a href="{{URL('/advertisment/viewpofiledetails',$ads->ads_id) }}" data-toggle="modal" onclick="view_modal(this.id)" title="User Details"  id ="{{ $ads->ads_id }}" data-target="#modal_view">View</a>
                                             </td>
                                            <td>{{ $ads->name }}</td>
                                            <td><img src="{{ URL('public/images/register') }}/{{ $ads->image }}" alt="" height="100px" width="100px"></td>
                                            ...
                                            @else
                                               <a href="{{URL('/advertisment/ChangeStatusProfile',$ads->ads_id) }}" class="btn btn-primary btn-sm">Pending Approval</a></td>
                                            @endif()
...
<script type="text/javascript">
  ...
  function view_modal(id){
    ...
    $.ajax({
      type : 'get',
      url : "{{ URL('/advertisment/viewprofiledetails') }}/"+id, 
