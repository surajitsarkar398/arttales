            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4>  Promotion Product</h4>
                    </div>
                    <div class="card-body">
                         @include('alert_message')
                        <form action="{{route('new_product_add_store')}}" method="POST" id=" "  enctype="multipart/form-data" >
                            @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-1 text-center">
                                            <label class="image-checkbox" title="England">
                                                ...
                                                ?>
                                              <img height="100px;" src="{{ URL('public/images/product') }}/{{ $images[0] }}" />
                                              <label class="lable">{{$item->product_name}}</label>
                                                <input type="checkbox" name="product[]" value="{{$item->product_id}}"  />
                                            </label>
                                        </div>
