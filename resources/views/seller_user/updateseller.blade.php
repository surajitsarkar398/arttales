        ...
        <div class="form-row">
            ...
            <div class="col-sm-12">
                ...
                <div class="card ">
                    ...
                    <form  action="{{URL('seller/saveEdit')}}"  enctype="multipart/form-data" method="post">
                         @csrf
                    <div class="card-body">
                        <div class="row">
                            <input type="hidden" name="register_id" value="{{$artist->register_id}}">
                      <div class="form-group col-md-3">    
                            ...
                            <img style="height:100px;" src="{{URL('public/images/artistLover/')}}/{{$artist->image}}" alt="">
                        </div>
                        <div class="form-group col-md-3">
                            <label for="demo-input-file" class="col-form-label">Enter Name</label>
                           <input class="form-control p" value="{{$artist->name}}" type="text"  id="demo-text-input" name="name"placeholder="Enter Your Name">
                        </div>
                        <div class="form-group col-md-1">
                            <label for="demo-input-file" class="col-form-label">Country Code</label>
                            <input class="form-control p" value="{{$artist->country_code}}" type="text"  id="demo-text-input" name="country_code" placeholder="CountryCode">

                        </div>
                        <div class="form-group col-md-5">
                            <label for="demo-input-file" class="col-form-label">Mobile Numnber</label>
                            <input class="form-control" value="{{$artist->mobile}}" type="tel"  id="demo-tel-input" placeholder="Enter Your Number" name="mobile">
                        </div>
                    </div>
                       ...
                       <div class="row">
                          <div class="form-group col-md-3">
                            ...
                            <input class="form-control" value="{{$artist->dob}}" type="date" name="dob" id="demo-date-only">
                        </div>
                         <div class="form-group col-md-3">
                            <label for="demo-date-only" class="col-form-label">Email</label>
                            <input class="form-control" type="email" value="{{$artist->email}}" name="email"  id="demo-email-input" placeholder="Enter Your Email">
                        </div>
                        <div class="form-group col-md-3">
                          ...
                          <div class="form-group col-md-3">
                            <label for="demo-date-only" class="col-form-label">Repassword</label>
                        ...
                        <div class="form-group">
                         ...
                         <select class="form-control p" required id="selectUser"name="role">
