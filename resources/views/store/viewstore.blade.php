                                ...
                                <table id="simpletable" class="table table-striped table-bordered nowrap">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><a href="{{route('store.detail',$store->store_id) }}" data-toggle="modal" onclick="view_modal(this.id)" title="User Details" id="{{ $store->store_id }}" data-target="#modal_view">View</a>
                                            <td>
