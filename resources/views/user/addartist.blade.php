                ...
                <div class="row align-items-center">
                      <div class="col-md-6">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Add Artist Lover</h5>
                        </div>
                    <div class="col-md-12">
                   <!--      <ul class="breadcrumb">
            ...
            <div class="col-sm-6">
                ...
                <div class="card ">
                    <div class="card-header">
                        <h5>Add Artist Lover</h5>
                    </div>
                     @include('alertmessage')
                    <form  action="{{URL('/user/addartist/store')}}"  enctype="multipart/form-data" method="post">
                         @csrf
                    <div class="card-body">
                      <div class="form-group">    
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                          <input class="form-control p" type="text"  id="demo-text-input" name="country_code" placeholder="Enter Your CountryCode">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                         ...
                         <select class="form-control p" id="selectUser"name="role">
                                  ...
                                  <option value="ArtistLover">Artist Lover</option>
                                  </select>
