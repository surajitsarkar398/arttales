            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                         ...
                         <form  action="{{URL('/user/viewartistlist/search')}}"  method="get" class="form-inline-my-2 my-lg-0 d-flex+"> 
                            @csrf
                            <div class="col-md-6 d-flex">
                             <input class="form-control p" type="search" id="search"  name="search" placeholder="Enter Your Performance" size="20">
                             <button type="submit"    name="hasCoffe
                             eMachine" class="btn btn-primary mr-2" style="margin-left: 12px;">Submit</button>
                         </div>
                         </form>
                            ...
                            <table id="simpletable" class="table table-striped table-bordered nowrap">
                                ...
                                <tbody>
                                    <tr>
                                            ...
                                            <td>{{ $users->role }}</td>
                                            <td>{{ $users->main_category_name }}</td>
                                            <td>{{ $users->sub_category_name }}</td>
                                            <td>{{ $users->type }}</td>
