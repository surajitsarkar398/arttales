                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <div class="page-header-title">
                           <a href="{{ route('artist-lover.index')  }}"><h5 class="m-b-10">Artist Lover List</h5></a>
                        </div>
                        <a href="{{ route('artist-lover.create')  }}" class="btn btn-danger mr-2" style="float:right;">
                            Add
                        </a>    
                    </div>
                </div>
                                ...
                                <tbody>
                                    ...
                                    @forelse ($users as $no => $user)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('artist-lover.detail',$user->register_id) }}">
                                                    <i class="fa fa-eye" aria-hidden="true" 
                                                    style="color:green;"></i>
                                                </a>
                                                &nbsp;&nbsp;
                                               
                                                <a href="{{route('artist-lover.edit',$user->register_id) }}">
...
<script type="text/javascript">
    function ChangeStatus(Id, Status)
    {
        ...
        $.ajax({
            url: "{{ URL('/artist-lover/ChangeStatus') }}/"+Id+"/"+Status,
            type: "GET",
            contentType: false,
            cache: false,
            processData:false,
