        ...
        <div class="form-row">
            ...
            <div class="col-sm-12"style="margin-top: 40px;">
                ...
                <div class="card-header">
                    ...
                    <form  action="{{URL('product/saveEdit')}}"  enctype="multipart/form-data" method="post">
                        ...
                        <div class="row">
                         ...
                         <div class="form-group col-md-6">
                          ...
                          <div class="form-group">
                            ...
                            <textarea class="form-control" type="text" name="product_description"  id="demo-email-input" value=''>{{  $productlist->product_description }}</textarea>
