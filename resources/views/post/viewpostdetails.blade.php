                        ...
                        <div class="dt-responsive table-responsive">
                            <table id="simpletable" class="table table-striped table-bordered nowrap">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <img src="{{ URL('public/images/post') }}/{{ $post_details[0]->post_image }}" alt="" height="50px" width="50px">
                                        </td>
                                        <td>{{ $post_details[0]->descriptions }}</td>
                                             <td>{{ $post_details[0]->tags }}</td>
                                            <td>{{ $post_details[0]->type }}</td>
                                            <td>{{ $post_details[0]->name }}</td>
                                    </tr>
                                </tbody>
                                <tfoot>
